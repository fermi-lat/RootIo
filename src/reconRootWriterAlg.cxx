...
* $Header: /nfs/slac/g/glast/ground/cvs/RootIo/src/reconRootWriterAlg.cxx,v 1.54.2.1 2005/06/01 08:17:43 usher Exp $
*/
...
void reconRootWriterAlg::close() 
{
   ...
   //    Used rather than TObject::kOverwrite - supposed to be safer but slower
    ...
    try {
        ...
        std::cerr << "Failed final write to RECON file" << std::endl;
        std::cerr << "Exiting..." << std::endl;
        std::cerr.flush();
        exit(1);
    }
